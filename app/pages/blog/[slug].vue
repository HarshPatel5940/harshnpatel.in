<template>
    ...
    >
        ...
        <article
            v-else-if="post"
            class="max-w-4xl mx-auto px-4 py-8 mt-5 blog-post"
        >
            <!-- Post Header -->
            <header class="mb-8">
                <!-- Featured Badge -->
            ...
            <!-- Post Content -->
            <div
                class="prose prose-lg dark:prose-invert max-w-none prose-green"
            >
    ...
    meta: [
        {
            name: "description",
            content:
                post.value?.description || "Read this blog post by Harsh Patel",
        },
        {
            property: "og:title",
            content: post.value
