...
<template>
  <div class="portfolio-page">
    <div class="content-wrapper">
      ...
      <div class="top-nav">
        <NuxtLink to="/blog" class="blog-link" :title="'Read my blog posts'">
          Blogs
        </NuxtLink>
        <button
          class="theme-toggle"
      ...
      <div id="description" class="description-container">
        <p class="description-text">
          I am a senior year undergrad dedicated to the pursuit of a Computer
          Science and Engineering degree, backed by a formidable
          <strong>four-year</strong> freelance tenure as a Backend and Bot
          Developer. Currently, I write code and have fun in
          <strong>Golang & TypeScript</strong>. My relentless enthusiasm for
          cutting-edge technologies and my commitment to
          <strong>open source initiatives</strong> propel my journey in this
          field.
        </p>

        <p class="description-text">
          As a Freelance Developer, I have had the privilege of collaborating
          with over <strong>30 clients</strong>, both national and
          <strong>international</strong>, on projects spanning bot development,
          automation, and web development.
        </p>

        <p class="description-text">
          For further inquiries or collaboration opportunities, please do not
          hesitate to reach out to me at
          <a href="mailto:hi@harshnpatel.in" target="_blank" class="email-link">
            hi@harshnpatel.in</a
          >
          or feel free to
          <a
